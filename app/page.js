...
export default function Home() {
  ...
  return (
    <Container maxWidth='100vw'>
        ...
        >
          <Typography variant="h2" gutterBottom>Welcome to CardQuest</Typography>
          <Typography variant="h5" gutterBottom>
            The easiest way to make flashcards from your text!
          </Typography>
          <Button variant="contained" color="primary" sx={{ mt: 2, mr: 2 }} href="/generate">Get Started</Button>
          <Button variant="contained" color="primary" sx={{ mt: 2 }} href="/flashcards">Saved Flashcards</Button>
        </Box>
        <Box sx={{ my: 6 }}>
